...
<figure style="margin: 0 auto 0.55em; display:block;">
  ...
  <figcaption style="width:50%">iiNUDGE changes data embeddings within a constrained region (shown in dashed lines) to maximize similarity with training queries. Data embeddings are colored based on queries for which they are the ground-truth answers</figcaption>
</figure>
